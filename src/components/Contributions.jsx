...
const Contributions = () => {
  ...
  return (
    <section id="contributions" className="relative py-4 sm:py-8 bg-black text-white overflow-hidden">
      ...
      <div className="max-w-[90rem] mx-auto px-6 sm:px-10 lg:px-24 relative z-10 flex flex-col items-center">
        ...
        <div className="flex flex-col gap-2 sm:gap-2 mb-2 sm:mb-4 text-center items-center">
          ...
          <div className="flex items-center justify-center gap-4 mt-2 sm:mt-4 opacity-50">
            <span className="text-[8px] sm:text-[10px] font-black tracking-[0.3em] uppercase text-gray-500 italic">Current GitHub Activity</span>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center gap-1 sm:gap-4 mb-2 sm:mb-4">
          ...
          <div className="w-full max-w-5xl flex flex-col items-center">
            ...
            {/* Mobile Scroll Hint */}
            <div className="mt-0 flex items-center gap-2 sm:hidden animate-pulse opacity-40">
          ...
          <div className="mt-2 sm:mt-6 flex items-center justify-center gap-6 w-full opacity-60">
